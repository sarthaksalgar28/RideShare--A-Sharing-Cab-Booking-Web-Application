    ...
    return (
        <section className="py-10 bg-gray-100">
            <div className="container mx-auto px-4">
                ...
                <h3 style={{ color: '#007BFF' }} className="text-2xl font-semibold mb-4">Our Mission</h3>
                <p className="mb-4">
                ...
                <h3 style={{ color: '#007BFF' }} className="text-2xl font-semibold mb-4">How It All Started</h3>
                <p className="mb-4">
                ...
                <h3 style={{ color: '#007BFF' }} className="text-2xl font-semibold mb-4">Meet Our Team</h3>
                ...
                <h3 style={{ color: '#007BFF' }} className="text-2xl font-semibold mb-4">Join Us</h3>
                <p>
