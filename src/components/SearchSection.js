                    ...
                    <form className="space-y-4">
                        <div className="flex space-x-4">
                            <div className="flex-1">
                                ...
                                <input className="w-full border-gray-300 rounded-lg p-2" id="from" placeholder="City or address" type="text"/>
                            </div>
                            <div className="flex-1">
                                <label className="block text-gray-700" htmlFor="to">To</label>
                                <input className="w-full border-gray-300 rounded-lg p-2" id="to" placeholder="City or address" type="text"/>
                            </div>
                        </div>
                        <div className="flex space-x-4">
                            <div className="flex-1">
                                <label className="block text-gray-700" htmlFor="date">Date</label>
                                <input className="w-full border-gray-300 rounded-lg p-2" id="date" type="date"/>
                            </div>
                            <div className="flex-1">
                                <label className="block text-gray-700" htmlFor="seats">Seats</label>
                                <input className="w-full border-gray-300 rounded-lg p-2" id="seats" placeholder="Number of seats" type="number"/>
                            </div>
                        </div>
